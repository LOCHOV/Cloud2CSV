...
def get_securityhub(accountid):
    ...
    try:
        paginator = support_client.get_paginator('get_findings')  # runs the API Call to get all the findings
        ...
        for page in response_iterator:
            for check in page["Findings"]:
                ...
                globallist.append(security_data) # appends each finding to the list of findings
