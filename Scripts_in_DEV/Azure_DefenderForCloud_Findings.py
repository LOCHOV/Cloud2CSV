...
- To run the script, use the following command with your subscription ID and credentials:
    python3 Azure_DefenderForCloud_Findings.py YourSubscriptionID YourTenantID YourClientID YourSecretKey "policy name or id"
...
def main():
    ...
    if login_response.status_code == 200:
        ...
        read_file = pandas.read_csv(cis_report_name)
        read_file.to_excel("CIS_Azure" + subscription + ".xlsx", index=None, header=True)
        os.remove(cis_report_name)
